...
<div class="info-section">
    ...
    <p style="font-size: 16px; line-height: 1.6; margin-bottom: 5px;"><strong>&bull; Name (English):</strong> Karen</p>
...
<div class="info-section">
    ...
    <div style="margin-left: 20px;">
    <p style="font-size: 16px; line-height: 1.6; margin-bottom: 5px;"><strong>&bull; Current Institution:</strong> Cornell University</p>
    <p style="font-size: 16px; line-height: 1.6; margin-bottom: 5px;"><strong>&bull; Major/Area of Study:</strong> Electrical and Computer Engineering</p>
    <p style="font-size: 16px; line-height: 1.6; margin-bottom: 5px;"><strong>&bull; Expected Graduation Date:</strong> 02/2026</p>
    <!-- 学术背景的更多内容 -->
    </div>
</div>
...
<div class="info-section">
    ...
    <!-- 个人荣誉的更多内容 -->
        <div style="display: flex; justify-content: space-between; margin-top: 20px;"> <!-- 添加了上边距 margin-top: 20px; -->
            <img src="../images/IMG_1492.png" style="flex: 1; max-width: 996px; max-height: 769px; width: 30%; height: auto; margin-right: 10px;" />
            <img src="../images/IMG_1493.png" style="flex: 1; max-width: 996px; max-height: 769px; width: 30%; height: auto; margin-left: 5px; margin-right: 5px;" />
            <img src="../images/IMG_1494.JPG" style="flex: 1; max-width: 996px; max-height: 769px; width: 30%; height: auto; margin-left: 10px;" />
        </div>
        <div style="display: flex; justify-content: space-between; margin-top: 20px;"> <!-- 添加了上边距 margin-top: 20px; 以分隔两排图片 -->
            <img src="../images/IMG_1495.JPG" style="flex: 1; max-width: 996px; max-height: 769px; width: 30%; height: auto; margin-right: 10px;" />
            <img src="../images/IMG_1580.JPG" style="flex: 1; max-width: 996px; max-height: 769px; width: 30%; height: auto; margin-left: 5px; margin-right: 5px;" />
            <img src="../images/IMG_1584.JPG" style="flex: 1; max-width: 996px; max-height: 769px; width: 30%; height: auto; margin-left: 10px;" />
        </div>
        <div style="display: flex; justify-content: space-between; margin-top: 20px;"> <!-- 添加了上边距 margin-top: 20px; 以分隔两排图片 -->
            <img src="../images/IMG_1587.JPG" style="flex: 1; max-width: 996px; max-height: 769px; width: 30%; height: auto; margin-right: 10px;" />
            <img src="../images/IMG_1582.JPG" style="flex: 1; max-width: 996px; max-height: 769px; width: 30%; height: auto; margin-left: 5px; margin-right: 5px;" />
            <img src="../images/IMG_1583.JPG" style="flex: 1; max-width: 996px; max-height: 769px; width: 30%; height: auto; margin-left: 10px;" />
        </div>
    </div>
</div>
...
<div class="image-row">
    <img src="../images/IMG_1556.JPG" />
    <img src="../images/IMG_1562.JPG" />
    <img src="../images/IMG_1563.JPG" />
</div>

<div class="image-row">
    <img src="../images/IMG_1561.JPG" />
    <img src="../images/IMG_1558.JPG" />
    <img src="../images/IMG_1560.JPG" />
</div>

<div class="image-row">
    <img src="../images/IMG_1879.JPG" />
    <img src="../images/IMG_1881.JPG" />
    <img src="../images/IMG_1882.JPG" />
</div>

<div class="image-row">
    <img src="../images/IMG_1888.JPG" />
    <img src="../images/IMG_1889.JPG" />
    <img src="../images/IMG_1890.JPG" />
</div>

<div class="image-row">
    <img src="../images/IMG_1893.JPG" />
    <img src="../images/IMG_1895.jpg" />
    <img src="../images/IMG_1896.jpg" />
</div>

<div class="image-row">
    <img src="../images/IMG_1899.JPG" />
    <img src="../images/IMG_1900.JPG" />
    <img src="../images/IMG_1901.JPG" />
</div>
